...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayCharts(data1, data2) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                labels: [data1.financials.years[2], data1.financials.years[1], data1.financials.years[0]],
                datasets: [{
                    label: 'Revenue',
                    backgroundColor: 'blue',
                    data: [data1.financials.revenue[2], data1.financials.revenue[1], data1.financials.revenue[0]],
                }, {
                    label: 'Earnings',
                    backgroundColor: 'green',
                    data: [data1.financials.earnings[2], data1.financials.earnings[1], data1.financials.earnings[0]],
                }, {
                    label: 'Assets',
                    backgroundColor: 'orange',
                    data: [data1.financials.assets[2], data1.financials.assets[1], data1.financials.assets[0]],
                }, {
                    label: 'Liabilities',
                    backgroundColor: 'red',
                    data: [data1.financials.liabilities[2], data1.financials.liabilities[1], data1.financials.liabilities[0]],
                }]
            },
        ...
        var chart2 = new Chart(ctx2, {
            ...
            data: {
                datasets: [{
                    label: 'min',
                    data: [data2.low[2], data2.min[1], data2.min[0]],
                }, {
                    label: 'max',
                    data: [data2.max[2], data2.max[1], data2.max[0]],
                }, {
                    label: 'average',
            
                    data: [data2.min[2], data2.financials.assets[1], data2.financials.assets[0]],
                }]
            },
